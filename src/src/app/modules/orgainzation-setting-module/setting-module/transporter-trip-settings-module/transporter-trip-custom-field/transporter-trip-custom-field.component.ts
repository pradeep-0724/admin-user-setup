import { TransporterTripService } from './transporter-trip-service.service';
import { Component, OnInit } from '@angular/core';
import { BehaviorSubject } from 'rxjs';

@Component({
  selector: 'app-transporter-trip-custom-field',
  templateUrl: './transporter-trip-custom-field.component.html',
  styleUrls: ['./transporter-trip-custom-field.component.scss'],
  host: {
    '(document:click)': 'outSideClick($event)'
  }
})
export class TransporterTripCustomFieldComponent implements OnInit {
  showOptions: string = '';
  popupOutputData: any;
  listIndexData = {};
  sortedData: any = [];
  ...
  url='revenue/formfield/trip/transporter/';
  editData=new BehaviorSubject([])
  constructor(private _customFiled:TransporterTripService) { }
  ...
  initView() {
    this._customFiled.getTransporterTripFields(false).subscribe((result:any)=>{
