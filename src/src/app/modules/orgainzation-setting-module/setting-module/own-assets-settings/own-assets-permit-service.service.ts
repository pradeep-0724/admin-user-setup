...
export class OwnAssetPermitService {
  constructor(private _http: HttpClient) {}
 
  addPermit(data): Observable<any> {
    return this._http.post(BASE_API_URL + 'asset/permit/',data);
  }
  ...
  updatePermit(id,data): Observable<any> {
    return this._http.put(BASE_API_URL + 'asset/permit/'+id+'/',data);
  }


  getPermit(id): Observable<any> {
    return this._http.get(BASE_API_URL + 'asset/permit/'+id+'/');
  }

  deletePermit(id): Observable<any> {
    return this._http.delete(BASE_API_URL + 'asset/permit/'+id+'/',{});
  }

  updateExpiryDateMandatory(id,value): Observable<any> {
    return this._http.put(BASE_API_URL + 'asset/permit/'+id+'/'+value+'/',{});
  }
}
