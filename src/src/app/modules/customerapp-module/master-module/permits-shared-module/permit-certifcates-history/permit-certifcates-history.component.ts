...
@Component({
  selector: 'app-permit-certifcates-history',
  templateUrl: './permit-certifcates-history.component.html',
  styleUrls: ['./permit-certifcates-history.component.scss']
})
export class PermitCertifcatesHistoryComponent implements OnInit {
