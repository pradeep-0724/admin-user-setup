...
@Component({
  selector: 'app-new-market-detiails-trip-history',
  templateUrl: './new-market-detiails-trip-history.component.html',
  styleUrls: ['./new-market-detiails-trip-history.component.scss']
})
export class NewMarketDetiailsTripHistoryComponent implements OnInit {
  ...
  tripHistoryHead: any
  currency_type: any
  constructor(private _setHeight:SetHeightService, private newMarketVehicelService: NewMarketVehicleService, private currency: CurrencyService) { }
  ...
  getTripHead() {
    this.newMarketVehicelService.marketVehicleTripHeader(this.vehicleId, this.queryParams).subscribe(resp => {      
  ...
  getTripList() {
    this.newMarketVehicelService.marketVehicleTripList(this.vehicleId, this.queryParamsTripList).subscribe((data) => {
  ...
  onScrollGetTripList(params) {
    this.isLoading = true;
    this.newMarketVehicelService.marketVehicleTripList(this.vehicleId, params).subscribe(data => {
