...
@Component({
  selector: 'app-vehicle-certifcates-history',
  templateUrl: './vehicle-certifcates-history.component.html',
  styleUrls: ['./vehicle-certifcates-history.component.scss']
})
export class VehicleCertifcatesHistoryComponent implements OnInit {
  ...
  ngOnInit(): void {
    this.isAttachment= this.data.isAttachment,
