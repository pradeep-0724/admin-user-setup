...
import { AddEditEmployeeBankModuleRoutingModule } from './add-edit-employee-bank-module-routing.module';
...
@NgModule({
  ...
  imports: [
    CommonModule,
    AddEditEmployeeBankModuleRoutingModule,
    ReactiveFormsModule,
    FormsModule,
    MatDatepickerModule,
    MatFormFieldModule,
...
export class AddEditEmployeeBankModule{ }
