...
@Component({
  selector: 'app-party-certificate-history',
  templateUrl: './party-certificate-history.component.html',
  styleUrls: ['./party-certificate-history.component.scss']
})
export class PartyCertificateHistoryComponent implements OnInit {
  documents:any=[];
  viewUploadedDocs={
    show: false,
    data:{}
