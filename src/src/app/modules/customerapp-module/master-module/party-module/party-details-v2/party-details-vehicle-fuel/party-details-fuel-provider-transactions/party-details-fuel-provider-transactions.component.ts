...
@Component({
  selector: 'app-party-details-fuel-provider-transactions',
  templateUrl: './party-details-fuel-provider-transactions.component.html',
  styleUrls: ['./party-details-fuel-provider-transactions.component.scss'],
  animations: [
    trigger('collapse', [
...
export class PartyDetailsFuelProviderTransactionsComponent implements OnInit {
