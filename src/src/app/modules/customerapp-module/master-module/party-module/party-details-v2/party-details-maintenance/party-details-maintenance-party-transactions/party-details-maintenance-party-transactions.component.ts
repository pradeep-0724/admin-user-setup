...
@Component({
  selector: 'app-party-details-maintenance-party-transactions',
  templateUrl: './party-details-maintenance-party-transactions.component.html',
  styleUrls: ['./party-details-maintenance-party-transactions.component.scss'],
  animations: [
    trigger('collapse', [
...
export class PartyDetailsMaintenancePartyTransactionsComponent implements OnInit {
  ...
  getUrl(bill) {
    ...
    if (bill.redirect.name == "jobcartservice")
      return this.getPrefixUrl + '/expense/maintenance/edit/service?job_card_id='+bill.redirect?.job_card_id +'&service_id='+ bill.redirect?.service_id +'&vehicleId='+bill?.redirect?.vehicle_id
