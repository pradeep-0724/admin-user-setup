...
@Component({
  selector: 'app-vehicle-provider-info',
  templateUrl: './vehicle-provider-info.component.html',
  styleUrls: ['./vehicle-provider-info.component.scss']
})
export class VehicleProviderInfoComponent implements OnInit {
  @Input() partyId =''
