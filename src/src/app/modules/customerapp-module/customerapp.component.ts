...
import { ConsoleLogService } from 'src/app/modules/customerapp-module/api-services/auth-and-general-services/console-log.service';
...
@Component({
  selector: 'app-customerapp-container',
  templateUrl: './customerapp.component.html',
})

export class CustomerappComponent implements OnInit,AfterViewInit {
  isOnboaded = false;
