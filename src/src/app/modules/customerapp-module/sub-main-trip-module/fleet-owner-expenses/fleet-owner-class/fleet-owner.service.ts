...
@Injectable({
  ...
  export class FleetOwnerClassService {
    ...
    constructor(private _employeeService: EmployeeService,
        ...
        getEmployeeList(employeeListCallBack){
           ...
           getPartyList(partyListCallBack){
            let $partyServiceSubscription= this._partyService.getPartyList(VendorType.VehicleProvider,PartyType.Vendor).subscribe((response) => {
