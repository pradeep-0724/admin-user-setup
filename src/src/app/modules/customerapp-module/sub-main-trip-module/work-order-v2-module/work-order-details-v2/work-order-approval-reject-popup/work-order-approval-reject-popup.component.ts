...
@Component({
  selector: 'app-work-order-approval-reject-popup',
  templateUrl: './work-order-approval-reject-popup.component.html',
  styleUrls: ['./work-order-approval-reject-popup.component.scss']
})
export class WorkOrderApprovalRejectPopupComponent implements OnInit {
