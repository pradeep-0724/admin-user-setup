...
@Component({
  selector: 'app-quotation-v2-header-section',
  templateUrl: './quotation-v2-header-section.component.html',
  styleUrls: ['./quotation-v2-header-section.component.scss']
})
export class QuotationV2HeaderSectionComponent implements OnInit, OnChanges {
  ...
  constructor(private _route: ActivatedRoute, private _analytics: AnalyticsService, public dialog: Dialog, private _quotationService: QuotationV2Service, private _commonService: CommonService, private router: Router,
    private _quotationV2DataService: QuotationV2DataService, private _ngxPermission: NgxPermissionsService,
  ...
  createWorKorderOrJob(isJob = false) {
    let duotationDetails = {
      vehicleCategory: this.quotationDetail['vehicle_category'],
      customer: {
