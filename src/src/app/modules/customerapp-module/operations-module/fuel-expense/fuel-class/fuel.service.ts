...
export class FuelClassService {
  ...
  getEmployeeList(employeeListCallBack) {
    let $employeeServiceSubscription = this._employeeService
      .getEmployeeList()
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $employeeServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getVehicleList(vehicleListCallBack) {
    let $vehicleServiceSubscription = this._vehicleService
      .getVehicleList()
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $vehicleServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getAccountsList(accountsListCallBack) {
    let $accountsServiceSubscription = this._revenueService
      .getAccounts("Expense")
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $accountsServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getPaymentAccountsList(paymentAccountsListCallBack) {
    let $paymentAccountsServiceSubscription = this._revenueService
      .getAccounts()
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $paymentAccountsServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getMaterialsList(materialsListCallBack) {
    let $materialsServiceSubscription = this._revenueService
      .getExpense()
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $materialsServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getExpenseAccountsAndSetAccountList(expenseListCallBack) {
    let $expenseServiceSubscription = this._revenueService
      .getAccounts("Expense,Other Expense,Cost of Services / COGS")
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $expenseServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
  ...
  getPartyList(partyListCallBack) {
    ...
    let $partyServiceSubscription = this._partyService
      .getPartyList("0,1", VendorParams)
      .subscribe(
        (response) => {
        ...
        () => {
          setTimeout(() => {
            $partyServiceSubscription.unsubscribe();
          }, 1000);
        }
      );
  }
